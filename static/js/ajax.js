...
<<<<<<< HEAD
     ...
     const descriptionValue = $('#id_description').val();
     const duedateValue = $('#floatingDdate').val();
     const priorityValue = $('#floatingPriority').val();
     const projectValue = $('#projectField').val();
...
<<<<<<< HEAD
        ...
        success: function(data) {
            ...
            if(data.priority=='High'){
                ...
                status='<span class="badge bg-primary">Medium </span>'
            }
            else{
...
<<<<<<< HEAD
            ...
            if(response.priority=='High'){
                ...
                status='<span class="badge bg-primary"><i class="bi circle "></i>'+response.priority+'</span>'
            }
            else{

                status='<span class="badge bg-success"><i class="bi circle "></i>'+response.priority+'</span>'
            }
            editedRow.find('td:eq(3)').html(status);
            editedRow.find('td:eq(4)').html('<a href="#" id="edit-task-btn" class="btn btn-primary edit-task-btn" data-task-id="'+response.taskid+'" ><i class="bi-pencil"></i></a>');
            editedRow.find('td:eq(5)').html('<a href="#" id="deletetask" class="btn btn-danger" data-task-id="'+response.taskid+'" > <i class="bi-trash"></i></a>');
            editedRow.find('td:eq(6)').html('<a href="#" id="showAddFormLink" class="btn btn-primary">Subtask <i class="bi-list-task"></i></a>');
            console.log("Updatfinish");
            location.reload(true); 
            // setTimeout(function() {
